  ...
  return [
    {
      ...
      last_login: new Date("2024-06-18T10:30:00"),
      created_at: new Date("2024-01-01T00:00:00"),
      updated_at: new Date("2024-06-18T10:30:00"),
    },
    {
      id: "user-2",
      name: "John Sales",
      ...
      last_login: new Date("2024-06-17T14:20:00"),
      created_at: new Date("2024-02-15T00:00:00"),
      updated_at: new Date("2024-06-17T14:20:00"),
    },
    {
      id: "user-3",
      name: "Sarah Tech",
      ...
      last_login: new Date("2024-06-16T09:00:00"),
      created_at: new Date("2024-03-01T00:00:00"),
      updated_at: new Date("2024-06-16T09:00:00"),
    },
    {
      id: "user-4",
      name: "Mike Viewer",
      ...
      created_at: new Date("2024-04-10T00:00:00"),
      updated_at: new Date("2024-05-01T00:00:00"),
    },
    {
      id: "user-5",
      name: "Admin User 2",
      ...
      last_login: new Date("2024-06-15T16:45:00"),
      created_at: new Date("2024-05-20T00:00:00"),
      updated_at: new Date("2024-06-15T16:45:00"),
    },
  ];
};
...
export const generateSampleSuppliers = (): Supplier[] => {
  return [
    ...
    },
    {
      ...
      phone_code: "+233",
      secondary_code: "+233",
      created_at: new Date("2024-04-05T11:20:00Z"),
      total_orders: 27,
      total_spent: 6700,
      status: "active",
    },
    {
      ...
      phone_code: "+233",
      secondary_code: "+233",
      created_at: new Date("2024-05-12T08:45:00Z"),
      total_orders: 56,
      total_spent: 15400,
      status: "active",
    },
    {
      ...
      phone_code: "+233",
      secondary_code: "+233",
      created_at: new Date("2024-06-18T13:30:00Z"),
      total_orders: 12,
      total_spent: 3200,
      status: "inactive",
    },{
    ...
    },
    {
      ...
      phone_code: "+233",
      secondary_code: "+233",
      created_at: new Date("2024-08-30T16:00:00Z"),
      total_orders: 24,
      total_spent: 6100,
      status: "active",
    },
    {
      ...
      phone_code: "+233",
      secondary_code: "+233",
      created_at: new Date("2024-09-14T10:45:00Z"),
      total_orders: 8,
      total_spent: 2100,
      status: "inactive",
    },
    {
      ...
      phone_code: "+233",
      secondary_code: "+233",
      created_at: new Date("2024-10-20T14:30:00Z"),
      total_orders: 31,
      total_spent: 7800,
      status: "active",
    },
