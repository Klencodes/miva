...
const ARTICLES: Article[] = [
  // ─── Getting Started ──────────────────────────────────────────────────────
  {
    ...
    content: (
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-text">Welcome to Your Business Management System</h2>
        <p className="text-text-light">
          This comprehensive system is designed to help you manage your business operations efficiently. 
          From invoicing to inventory management, customer relationships to expense tracking, everything 
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p className="text-text-light">The system is organized into modules accessible from the sidebar:</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">Overview of key metrics and recent activity</p>
          </div>
          <div className="border border-border rounded-lg p-3">
            <div className="flex items-center gap-2 text-primary font-medium">
            ...
            <p className="text-sm text-text-light mt-1">Create, send, and manage invoices</p>
          </div>
          <div className="border border-border rounded-lg p-3">
            <div className="flex items-center gap-2 text-primary font-medium">
            ...
            <p className="text-sm text-text-light mt-1">Track stock levels and manage products</p>
          </div>
          <div className="border border-border rounded-lg p-3">
            <div className="flex items-center gap-2 text-primary font-medium">
            ...
            <p className="text-sm text-text-light mt-1">Track and manage business expenses</p>
          </div>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-text">Organisation Management</h2>
        <p className="text-text-light">
          The system supports multiple organisations (entities) under one account. This is useful for:
        </p>
        ...
        <div className="bg-amber-10 p-4 rounded-lg border border-amber-200">
          ...
          <p className="text-sm text-amber-700 mt-1">
            Click on the organisation name in the sidebar dropdown to switch between different entities. 
  ...
  // ─── Dashboard ────────────────────────────────────────────────────────────
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p className="text-text-light">
          The dashboard provides a high-level view of your business performance with key metrics and recent activity.
        </p>
    ...
    content: (
      <div className="space-y-4">
        ...
        <ol className="list-decimal list-inside text-text-light space-y-2">
          <li>Navigate to <strong>Invoicing</strong> from the sidebar</li>
          <li>Click the <strong>+ New Invoice</strong> button</li>
          ...
          <li>Click <strong>Save</strong> or <strong>Save & Send</strong></li>
        </ol>
        <div className="bg-primary-10 p-4 rounded-lg">
          <h4 className="font-semibold text-primary">💡 Pro Tip</h4>
          <p className="text-sm text-text-light">
            Use the "Save & Send" option to email the invoice directly to your customer as a PDF.
          </p>
        </div>
      </div>
    ),
    ...
    content: (
      <div className="space-y-4">
        ...
        <ol className="list-decimal list-inside text-text-light space-y-2">
          ...
          <li>Click the <strong>+ Add Payment</strong> button</li>
          <li>Enter the payment amount (partial or full)</li>
          <li>Select payment method: Cash, Bank, Mobile Money, or Credit Card</li>
          <li>Add reference number if applicable</li>
          <li>Click <strong>Save Payment</strong></li>
        </ol>
        <p className="text-text-light">
          Payments will automatically update the invoice status and remaining balance.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-text">Invoice Statuses Explained</h2>
        <div className="grid grid-cols-1 gap-3">
          <div className="border border-border rounded-lg p-3">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 bg-gray-200 text-gray-700 rounded-full text-xs">Draft</span>
              <span className="text-sm text-text-light">Work in progress, not yet finalized</span>
            </div>
          </div>
          <div className="border border-border rounded-lg p-3">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full text-xs">Quoted</span>
              <span className="text-sm text-text-light">Sent as a quote, awaiting acceptance</span>
            </div>
          </div>
          <div className="border border-border rounded-lg p-3">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 bg-primary-10 text-primary rounded-full text-xs">Invoiced</span>
              <span className="text-sm text-text-light">Finalized and sent to customer</span>
            </div>
          </div>
          <div className="border border-border rounded-lg p-3">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 bg-amber-100 text-amber-700 rounded-full text-xs">Partially</span>
              <span className="text-sm text-text-light">Partial payment received</span>
            </div>
          </div>
          <div className="border border-border rounded-lg p-3">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 bg-emerald-100 text-emerald-700 rounded-full text-xs">Paid</span>
              <span className="text-sm text-text-light">Fully paid</span>
            </div>
          </div>
          <div className="border border-border rounded-lg p-3">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 bg-red-100 text-red-700 rounded-full text-xs">Cancelled</span>
              <span className="text-sm text-text-light">Cancelled by user</span>
            </div>
          </div>
          <div className="border border-border rounded-lg p-3">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 bg-rose-100 text-rose-700 rounded-full text-xs">Overdue</span>
              <span className="text-sm text-text-light">Payment past due date</span>
            </div>
          </div>
        </div>
      </div>
  ...
  // ─── Inventory ─────────────────────────────────────────────────────────────
  {
    ...
    content: (
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-text">Inventory Management</h2>
        <div className="space-y-3">
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">
              Click the <strong>Add Item</strong> button to create new products. Include details like name, 
              part number, type, unit, cost, price, and reorder threshold.
            </p>
          </div>
          <div className="border border-border rounded-lg p-3">
            <h4 className="font-medium text-text flex items-center gap-2">
            ...
            <p className="text-sm text-text-light mt-1">
              Products with low stock (quantity ≤ reorder threshold) are highlighted in amber. 
          ...
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">
              Use the <strong>+</strong> and <strong>-</strong> buttons on each product to quickly adjust stock levels.
              For bulk adjustments, use the edit feature.
            </p>
          </div>
        </div>
      </div>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p className="text-text-light">
          Products can be categorized by type for better organization and filtering:
        </p>
        <div className="grid grid-cols-2 gap-3">
          <div className="border border-border rounded-lg p-3">
            <span className="inline-block px-2 py-0.5 bg-primary-10 text-primary rounded-full text-xs">Hose</span>
            <p className="text-sm text-text-light mt-1">Hydraulic hoses and tubing</p>
          </div>
          <div className="border border-border rounded-lg p-3">
            <span className="inline-block px-2 py-0.5 bg-emerald-100 text-emerald-700 rounded-full text-xs">Fitting</span>
            <p className="text-sm text-text-light mt-1">Connectors and adapters</p>
          </div>
          <div className="border border-border rounded-lg p-3">
            <span className="inline-block px-2 py-0.5 bg-amber-100 text-amber-700 rounded-full text-xs">Ferrule</span>
            <p className="text-sm text-text-light mt-1">Crimping ferrules</p>
          </div>
          <div className="border border-border rounded-lg p-3">
            <span className="inline-block px-2 py-0.5 bg-purple-100 text-purple-700 rounded-full text-xs">Adapter</span>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">
              Click <strong>Add Customer</strong> to create a new customer profile. Required fields include 
              name, email, and phone number. You can also add address and tax ID information.
            </p>
          </div>
          <div className="border border-border rounded-lg p-3">
            <h4 className="font-medium text-text">Customer Insights</h4>
            <p className="text-sm text-text-light mt-1">
              Each customer profile shows their invoice history, total spent, outstanding balance, and 
              recent transactions.
            </p>
          </div>
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">
              Customers can be marked as <span className="text-emerald-600">Active</span> or 
              <span className="text-red-600"> Inactive</span>. Inactive customers won't appear in 
              invoice creation dropdowns.
            </p>
          </div>
        </div>
      </div>
  ...
  // ─── Suppliers ────────────────────────────────────────────────────────────
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p className="text-text-light">
          Maintain a comprehensive list of your suppliers to streamline purchasing and expense tracking.
        </p>
        <div className="grid grid-cols-1 gap-3">
          <div className="border border-border rounded-lg p-3">
          ...
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">
              Suppliers are linked to expense tracking and inventory management for complete visibility 
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">
              Click <strong>Add Expense</strong> to record a new expense. Include title, category, 
          ...
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">
              Expenses start as <span className="text-amber-600">Pending</span>. They can be marked as 
              <span className="text-emerald-600"> Paid</span> once approved. Only pending expenses can be 
              edited or deleted.
            </p>
          </div>
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">
              View spending trends by category and over time. The dashboard shows total expenses, paid vs 
              pending amounts, and category breakdowns.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">
              Navigate to <strong>Team</strong> and click <strong>Add User</strong>. Enter their details 
              and assign a role.
            </p>
          </div>
          <div className="border border-border rounded-lg p-3">
            ...
            <ul className="text-sm text-text-light space-y-2 mt-2">
              <li><span className="text-primary font-medium">Super Admin</span> - Full system access</li>
              <li><span className="text-primary font-medium">Admin</span> - Manage all modules</li>
              <li><span className="text-primary font-medium">Sales</span> - Create invoices and manage customers</li>
              <li><span className="text-primary font-medium">Inventory Manager</span> - Manage stock and products</li>
              <li><span className="text-primary font-medium">Viewer</span> - Read-only access</li>
            </ul>
          </div>
          <div className="border border-border rounded-lg p-3">
            <h4 className="font-medium text-text">User Permissions</h4>
            <p className="text-sm text-text-light mt-1">
              Each role has specific permissions. Users can be activated or deactivated as needed.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="border border-border rounded-lg p-3">
            ...
            <p className="text-sm text-text-light mt-1">
              Admins can create new organisations from the <strong>Organisations</strong> section. 
          ...
          <div className="border border-border rounded-lg p-3">
            <h4 className="font-medium text-text">Assigning Users to Organisations</h4>
            <p className="text-sm text-text-light mt-1">
              Users can be assigned to one or multiple organisations. Each user has a primary organisation 
  ...
  // ─── Settings ─────────────────────────────────────────────────────────────
  {
    ...
    content: (
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-text">System Configuration</h2>
        <div className="grid grid-cols-1 gap-3">
          <div className="border border-border rounded-lg p-3">
          ...
          <div className="flex-1 max-w-md">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 bg-background border border-border rounded-lg text-sm text-text placeholder:text-text-light focus:outline-none focus:ring-2 focus:ring-primary/50"
              />
            </div>
          </div>
        </div>
        ...
        {selectedArticle ? (
          ...
          <div className="h-full overflow-y-auto">
            <div className="max-w-6xl mx-auto px-4 py-6">
              ...
              {!searchQuery && !selectedCategory && (
                <div className="mb-8">
                  <h2 className="text-lg font-semibold text-text mb-3">Featured Articles</h2>
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-medium text-text truncate">{article.title}</h3>
                      ...
                      {CATEGORIES.map((category) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-xs text-text-light">{articleCount}</span>
                          </button>
                        );
                      })}
                    </div>
                ...
                <div className="lg:col-span-3">
                  {filteredArticles.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-lg font-semibold text-text">No articles found</h3>
                        ...
                        >
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm text-text-light mt-1">{article.description}</p>
