            ...
            <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center p-8">
              ...
              <div className="max-w-2xl mx-auto">
                ...
                <div className="bg-card rounded-lg p-6 mb-8 border border-border shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div className="bg-background p-4 rounded-lg">
                      <div className="flex items-center mb-2">
                        ...
                        <h3 className="font-semibold text-text">Request Process</h3>
                      </div>
                      <p className="text-sm text-text-light">
                        Contact your system administrator or manager to request access to this section.
                      </p>
                    </div>
                    ...
                    <div className="bg-background p-4 rounded-lg">
                      <div className="flex items-center mb-2">
                        ...
                        <h3 className="font-semibold text-text">Typical Wait Time</h3>
                      </div>
                      <p className="text-sm text-text-light">
                        Access requests are usually processed within 24-48 business hours.
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Steps to Get Access */}
                  <div className="mb-8">
                    <h3 className="font-semibold text-text mb-4 text-left">Steps to Get Access:</h3>
                    <div className="space-y-4">
                      {[
                        { icon: 'ri-message-3-line', text: 'Contact your administrator or supervisor' },
                        { icon: 'ri-file-text-line', text: 'Submit an access request form if required' },
                        { icon: 'ri-user-settings-line', text: 'Provide justification for needing access' },
                        { icon: 'ri-shield-check-line', text: 'Wait for approval and security review' }
                      ].map((step, index) => (
                ...
                <div className="mt-8 p-6 bg-card rounded-lg border border-border">
                  <h3 className="font-semibold text-text mb-4">Need Immediate Help?</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="text-center p-4 bg-background rounded-lg">
                      ...
                      <p className="text-sm text-text-light">klencodes@gmail.com</p>
                    </div>
                    <div className="text-center p-4 bg-background rounded-lg">
